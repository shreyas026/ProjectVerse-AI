...
export function MessagesPage() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] -mx-4 lg:-mx-8 -mt-4">
      <Card className="h-full flex overflow-hidden rounded-none lg:rounded-xl border-0 lg:border">
        {/* Conversation List */}
                ...
                >
                  <div className="relative">
                    <Avatar className="w-11 h-11">
                      ...
                      <AvatarFallback>{conv.name?.[0] || other?.firstName?.[0]}</AvatarFallback>
                    </Avatar>
                    {conv.unreadCount > 0 && (
          ...
          <div className={`flex-1 flex flex-col ${!activeConv ? 'hidden lg:flex' : 'flex'}`}>
            ...
            <div className="flex items-center gap-3 p-4 border-b">
              ...
              <Avatar className="w-10 h-10">
                ...
                <AvatarFallback>{activeConversation.name?.[0] || otherParticipant?.firstName?.[0]}</AvatarFallback>
              </Avatar>
              <div className="flex-1 min-w-0">
            ...
            <div className="p-4 border-t">
              <div className="flex items-center gap-2">
                ...
                <Button size="icon" className="h-9 w-9 shrink-0" disabled={!messageText.trim()}>
