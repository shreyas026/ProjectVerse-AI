...
import {
  Github, Linkedin, Globe, Mail, MapPin, BookOpen,
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Placement Ready', value: `${user.scores?.placementReadiness}%`, raw: user.scores?.placementReadiness, max: 100, icon: Star, color: 'text-purple-500' },
        ].map((stat) => (
          <Card key={stat.label}>
