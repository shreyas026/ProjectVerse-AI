...
import { Bot, User, BookOpen, Briefcase, Target, Award, Sparkles, Compass, GraduationCap } from 'lucide-react';
...
export function AIMentorPage() {
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const responseText = `That is an excellent question! As your AI Mentor, I am here to help you navigate your tech career. Based on your profile (CSE student with React, Node.js, and Python skills), here is what I recommend:\n\n1. **Continue strengthening your full-stack skills** - You are already good with React and Node.js\n2. **Add AI/ML to your toolkit** - Your Python knowledge is a great foundation\n3. **Build projects that combine both** - Full-stack AI applications are in high demand\n\nWould you like me to create a detailed learning plan or help you with something specific?`;
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="p-4 border-t">
            <div className="flex gap-2 max-w-3xl mx-auto">
              <Input placeholder="Ask your AI Mentor anything..." className="flex-1" value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleSend()} />
