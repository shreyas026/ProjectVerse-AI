...
export const mockProjects: Project[] = [
  {
    _id: '1', title: 'Smart Agriculture IoT Platform', description: 'A comprehensive IoT-based smart farming solution that uses sensors, ML models, and a modern web dashboard to help farmers monitor crops, predict yields, and optimize resource usage.', shortDescription: 'IoT-based smart agriculture monitoring system with ML-powered insights',
  ...
  {
    _id: '2', title: 'AI Study Assistant', description: 'An intelligent study companion powered by LLMs that helps students prepare for exams, summarize lecture notes, and generate practice questions.', shortDescription: 'AI-powered study companion for students',
  ...
  {
    _id: '3', title: 'Campus Marketplace', description: 'A peer-to-peer marketplace platform for college students to buy, sell, and exchange textbooks, electronics, and other items.', shortDescription: 'P2P marketplace for college students',
...
export const mockChallenges: CodingChallenge[] = [
  { _id: '1', title: 'Two Sum', description: 'Given an array of integers and a target, return indices of two numbers that add up to target.', difficulty: 'easy', problemStatement: 'Given an array of integers nums and an integer target, return indices of the two numbers such that they add up to target.', inputFormat: 'First line: n, Second line: n space-separated integers, Third line: target', outputFormat: 'Two space-separated indices', constraints: '2 <= nums.length <= 10^4', examples: [{ input: '4\n2 7 11 15\n9', output: '0 1', explanation: 'nums[0] + nums[1] = 2 + 7 = 9' }], tags: ['array', 'hash-table'], category: 'algorithms', points: 10, timeLimit: 1000, memoryLimit: 256, totalSubmissions: 15420, totalAccepted: 12300, acceptanceRate: 79.8, hints: ['Try using a hash map'], createdAt: '2024-01-01' },
  { _id: '2', title: 'Merge K Sorted Lists', description: 'Merge k sorted linked lists and return it as one sorted list.', difficulty: 'hard', problemStatement: 'You are given an array of k linked-lists, each linked-list is sorted in ascending order. Merge all the linked-lists into one sorted linked-list and return it.', inputFormat: 'First line: k, Next k lines: sorted integers for each list', outputFormat: 'Space-separated sorted integers', constraints: 'k == lists.length, 0 <= k <= 10^4', examples: [{ input: '3\n1 4 5\n1 3 4\n2 6', output: '1 1 2 3 4 4 5 6', explanation: 'Merging three sorted lists' }], tags: ['linked-list', 'divide-and-conquer', 'heap'], category: 'data_structures', points: 50, timeLimit: 2000, memoryLimit: 256, totalSubmissions: 8900, totalAccepted: 4500, acceptanceRate: 50.6, hints: ['Consider using a min-heap'], createdAt: '2024-01-15' },
  { _id: '3', title: 'Binary Tree Level Order Traversal', description: 'Given the root of a binary tree, return the level order traversal of its nodes values.', difficulty: 'medium', problemStatement: 'Given the root of a binary tree, return the level order traversal of its nodes values.', inputFormat: 'Serialized binary tree (level order)', outputFormat: 'Each level on a new line, space-separated values', constraints: 'The number of nodes in the tree is in the range [0, 2000]', examples: [{ input: '3 9 20 null null 15 7', output: '3\n9 20\n15 7', explanation: 'Level 0: [3], Level 1: [9,20], Level 2: [15,7]' }], tags: ['tree', 'bfs', 'binary-tree'], category: 'data_structures', points: 25, timeLimit: 1000, memoryLimit: 128, totalSubmissions: 12300, totalAccepted: 9800, acceptanceRate: 79.7, hints: ['Use a queue for BFS'], createdAt: '2024-02-01' },
];
